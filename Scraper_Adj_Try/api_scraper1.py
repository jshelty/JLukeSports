...
class MLB_Scrape:
    ...
    def get_data_df(self, data_list):
                    ...
                    for n in range(len(ab_list['playEvents'])):
                        ...
                        if ab_list['playEvents'][n]['isPitch'] == True or 'call' in ab_list['playEvents'][n]['details']:
                            ...
                            if 'pitchData' in ab_list['playEvents'][n]:
                                ...
                                release_pos_x.append(ab_list['playEvents'][n]['pitchData']['coordinates']['release_pos_x'] if 'release_pos_x' in ab_list['playEvents'][n]['pitchData']['coordinates'] else None)
                                release_pos_z.append(ab_list['playEvents'][n]['pitchData']['coordinates']['release_pos_z'] if 'release_pos_z' in ab_list['playEvents'][n]['pitchData']['coordinates'] else None)
                                z_release_point.append(ab_list['playEvents'][n]['pitchData']['coordinates']['z_release_point'] if 'z_release_point' in ab_list['playEvents'][n]['pitchData']['coordinates'] else None)
                                ...
                                ivb.append(None)
                                hb.append(None)
                                release_pos_x.append(None)
                                release_pos_z.append(None)
                                z_release_point.append(None)
        ...
        df  = pl.DataFrame(data={
            ...
            'ivb':ivb,
            'hb':hb,
            'release_pos_x': release_pos_x,  # Include release_pos_x
            'release_pos_z': release_pos_z,   # Include release_pos_z
            'z_release_point': z_release_point, # Include z_release_point
